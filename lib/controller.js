...
exports.validLinks = exports.getLinks = exports.readFileSync = exports.readDirectorySync = exports.isFileSync = exports.isDirectoryAsync = exports.isDirectorySync = exports.convertToAbsolute = exports.isAbsolute = void 0;
...
const validLinks = arrPaths => {
  ...
  return Promise.all(arrLinks).then(() => {
    return arrObj;
  }).catch(error => {
    return error;
  });
...
console.log(validLinks(['C:\\Users\\Laboratoria\\Desktop\\Markdown\\LIM008-fe-md-links\\directoryForTest\\FILEMD.md']));